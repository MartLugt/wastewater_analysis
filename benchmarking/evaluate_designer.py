...
def main():
    ...
    parser.add_argument('--abundance', dest='abundance', type=float, required=True)
    ...
    plot_single_frq_val = min(unique_freq_vals, key=lambda x:abs(x-args.abundance))
